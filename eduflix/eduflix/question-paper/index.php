...
<body>
    ...
    <div class="hero_area">
        ...
        if (isset($_GET['submit'])) {
            ...
            $query = "select question_paper.question_paper_name from question_paper inner join subject on subject.subject_id = question_paper.subject_id inner join courses on courses.cource_id = subject.cource_id inner join colleges on colleges.college_id = courses.college_id where colleges.college_name = '{$college}' AND courses.cource_name = '{$course}' AND subject.sem = '{$sem}'";
        ...
        ?>
                        <tr>
                            <td> <?php echo $Row['question_paper_name']; ?> </td>
                            <td><a href="../papers/<?php echo $Row['question_paper_name'] . '.pdf' ?>" target="_blank"> View </a> </td>
                        </tr>
        <?php
                    }
                    echo '</table> </section>';
