...
<body>
    ...
    <div class="hero_area">
        ...
        if (isset($_GET['submit'])) {
            ...
            $query = "select ppts.ppt_name from ppts inner join subject on subject.subject_id = ppts.subject_id inner join courses on courses.cource_id = subject.cource_id inner join colleges on colleges.college_id = courses.college_id where colleges.college_name = '{$college}' AND courses.cource_name = '{$course}' AND subject.sem = '{$sem}'";
        ...
        ?>
                        <tr>
                            <td> <?php echo $Row['ppt_name']; ?> </td>
                            <td><a href="../material/<?php echo $Row['ppt_name'] . '.pptx' ?>" target="_blank"> View </a> </td>
                        </tr>
        <?php
                    }
                    echo '</table> </section>';
