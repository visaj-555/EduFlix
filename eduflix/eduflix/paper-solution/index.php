...
<body>
    ...
    <div class="hero_area">
        ...
        if (isset($_GET['submit'])) {
            ...
            $query = "select paper_solution.paper_solution_name from paper_solution inner join subject on subject.subject_id = paper_solution.subject_id inner join courses on courses.cource_id = subject.cource_id inner join colleges on colleges.college_id = courses.college_id where colleges.college_name = '{$college}' AND courses.cource_name = '{$course}' AND subject.sem = '{$sem}'";
        ...
        ?>
                        <tr>
                            <td> <?php echo $Row['paper_solution_name']; ?> </td>
                            <td><a href="../solution/<?php echo $Row['paper_solution_name'] . '.pdf' ?>" target="_blank"> View </a> </td>
                        </tr>
        <?php
                    }
                    echo '</table> </section>';
